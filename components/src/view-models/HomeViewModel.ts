...
export default function useHomeViewModel() {
  ...
  const limit = 4; // Itens por página
  ...
  useEffect(() => {
    fetchMissingPersons(1); // Carrega a primeira página ao montar o componente
  }, []);
  ...
  return { missingPersons, loading, error, fetchMissingPersons, loadMore, loadingMore, hasMore };
}
